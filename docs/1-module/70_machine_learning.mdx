...
Now it's your turn to build a CNN from scratch.
We'll use a new dataset (More details once finalized). Please load the dataset using this code:
...
Build a CNN with this architecture
...
- **Run A (baseline)**: `epochs = 5`, `batch_size = 64`, `dropout = 0.5`
- **Run B (train much longer)**: `epochs = 20`, `batch_size = 64`, `dropout = 0.5`
- **Run C (train longer, remove dropout)**: `epochs = 20`, `batch_size = 64`, `dropout = 0.0`
