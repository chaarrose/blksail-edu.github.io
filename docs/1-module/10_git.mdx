...
Before initializing a Git repository, create (or navigate to) your project directory:

```sh
mkdir my-project # this creates a new directory called "my-project"
cd my-project    # this navigates into the "my-project" directory
```
