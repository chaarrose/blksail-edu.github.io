...
To avoid conflicts between different Python projects, it is a good idea to use virtual environments.
...
You can verify this by checking your terminal prompt.
If the virtual environment is active, its name `python-refresher` should appear at the beginning of the prompt.
:::
